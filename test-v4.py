...
#                   cmd=> sar -n DEV 1 100
# 
#   Description:    base on test-v3-new
#                   aim at 1: adding window warning
#                          2: improve check function
#   requirement:    every loop, if 5 consistent miss happen
#                   of 5 bit error happen                       not ideal
#                   occur a new warning window                  not ideal
#                   csv output file                             done
#                   add cmd parameter of error injection        done
#############################################################################
...
#############################################################################
if file_enable:
    filename = 'Ethernet-' + time.strftime("%Y.%m.%d-%H.%M.%S") + '-' + 'log'
...
def check():
    ...
    if( len(BUFFER_recv_store) < (loop_size - 5) ):
        Miss5Packet = 1
    else:
        Miss5Packet = 0
...
print('Miss5Packet is %d .'%Miss5Packet)
print('All work done .')

...
filename    = 'Uart-' + time.strftime("%Y.%m.%d-%H.%M.%S") + '-' + 'log'
...
writer.writerow(["timestamp","timenow","Time","Err_sram","Err_pllser","Err_pllsys",\
    "Err_plleth","Err_pll1","Err_pll2","Err_pllcas","Err_dff","Err_dffinv","Err_lane0",\
        "Err_lane1","Err_linkdown0","Err_linkdown1","Err_linkrecvy0","Err_linkrecvy1",\
            "Err_cpu","Reset_ALL"])


row_reg1    =   ["Time","Err_sram","Err_pllser","Err_pllsys","Err_plleth","Err_pll1"]
row_reg2    =   ["Err_pll2","Err_pllcas","Err_dff","Err_dffinv","Err_lane0","Err_lane1"]
row_reg3    =   ["Err_linkdown0","Err_linkdown1","Err_linkrecvy0","Err_linkrecvy1","Err_cpu","Reset_ALL"]
    ...
    try:
        ...
        while(True):
            ...
            if( write_occur == 0 ):
                ...
                tb.field_names  =   ["time",":",time.strftime("%H:%M:%S"),\
                ...
                tb.add_row(row_reg3)
                row_data3    =    data_tmp[12:18]
                tb.add_row(row_data3)
